const strings = {
  website: "https://ja.pattern.monster",
  title: "Pattern Monster",
  description:
    "繰り返しSVGパターンを作成するためのシンプルなオンラインパターンジェネレーター。",
  description2: "画像品質を犠牲にせずにウェブサイトの速度を上げます。",
  description3: 
    "ウェブサイトの背景、アパレル、ブランディング、パッケージデザインなどに最適。",
  keywords:
    "svgパターン、パターン、svg背景、ベクター壁紙、パターンジェネレーター、パターンメーカー",
  pages: [
    {
      page: "index",
      title: "SVGパターンジェネレーター",
      keywords: "",
      description: "",
      image: "",
    },
